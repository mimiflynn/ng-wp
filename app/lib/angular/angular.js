 ...
 *   }]);
     ...
     *
     * <pre>
     * var wpNg = angular.module('wpNg', []);
     * wpNg.run(function($templateCache) {
 ...
 * Strict Contextual Escaping (SCE)}.
     ...
     *
     * - your app is hosted at url `http://wpNg.example.com/`
     * - but some of your templates are hosted on other domains you control such as
     *   `http://srv01.assets.example.com/`,  `http://srv02.assets.example.com/`, etc.
     * - and you have an open redirect at `http://wpNg.example.com/clickThru?...`.
     *
     * Here is what a secure configuration for this scenario might look like:
     *
     * <pre class="prettyprint">
     *    angular.module('wpNg', []).config(function($sceDelegateProvider) {
 ...
 *        'http://wpNg.example.com/clickThru**']);
 *      });
     * </pre>
     */
 ...
 * Same Origin Policy} and {@link http://www.w3.org/TR/cors/ Cross-Origin Resource Sharing (CORS)}
     ...
     * @example
     ...
     <file name="index.html">
     <div ng-controller="wpNgController as myCtrl">
     ...
     mySceApp.controller("wpNgController", function wpNgController($http, $templateCache, $sce) {
    var self = this;
     ...
     *
     * <pre class="prettyprint">
     *   angular.module('wpNgWithSceDisabledwpNg', []).config(function($sceProvider) {
